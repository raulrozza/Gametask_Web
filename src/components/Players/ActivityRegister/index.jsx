...
const RequestModal = ({ request, deleteRequest, acceptRequest }) => (
  <div className="request-modal">
    <header>
      ...
      />
      <strong>{request.activity.name} ({request.activity.experience} XP)</strong>
      <span>
        concluído por{' '}
    ...
    <section>
      ...
      {request.activity.dmRules && <cite>Recomendações: "{request.activity.dmRules}"</cite>}
    </section>
    <footer>
      <cite>
        Requisição feita em{' '}
